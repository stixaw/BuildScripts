...
try:
  ...
  X86_MSI = [
    ...
    #r'%s\apps\DeploymentInstall\Symantec_DeploymentSolution_7_1_SP2_x86.msi' % top,
  ...
  X64_MSI = [
    ...
    r'%s\apps\DeploymentInstall\Symantec_DeploymentSolution_LINUX_7_1_SP2_x64.msi' % top
...
#changes the read-only files created by Silverlight scons for clean-up
  DEV_OEM_X64_AGNT_DIR = top + r'\OEM\DS\winpe\x64\Base'
  DEV_OEM_X86_AGNT_DIR = top + r'\OEM\DS\winpe\x86\Base'  
...
def DevClean():
  global top
  DEV_OEM_X64_AGNT_DIR = top + r'\OEM\DS\winpe\x64\Base\Program Files\Altiris\Altiris Agent'
  DEV_OEM_X64_TASKS_DIR = top + r'\OEM\DS\winpe\x64\Base\Program Files\Altiris\Altiris Agent\Agents\Agent Tasks'
  DEV_OEM_X86_AGNT_DIR = top + r'\OEM\DS\winpe\x86\Base\Program Files\Altiris\Altiris Agent'
  DEV_OEM_X86_TASKS_DIR = top + r'\OEM\DS\winpe\x86\Base\Program Files\Altiris\Altiris Agent\Agents\Agent Tasks'
