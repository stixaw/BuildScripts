...
def Copy_LPMSI():
  ...
  if os.path.isfile(MSI_DIR + '\\Altiris_DeploymentSolutionLanguages_x86_7_1.msi'):
    os.rename(MSI_DIR + '\\Altiris_DeploymentSolutionLanguages_x86_7_1.msi', MSI_DIR + '\\DeploymentSolutionLanguages_x86.msi')
