...
def Copy_LPMSI():
  ...
  if os.path.isfile(MSI_DIR + '\\Altiris_DeploymentSolutionLanguages_x64_7_1.msi'):
    os.rename(MSI_DIR + '\\Altiris_DeploymentSolutionLanguages_x64_7_1.msi', MSI_DIR + '\\DeploymentSolutionLanguages_x64.msi')
  if not os.path.exists('C:\\output_msi'):
    os.makedirs('C:\\output_msi')
  #copy renamed MSI To output_msi
  print "copying DeploymentSolutionLanguages_x64.msi to C:\\output_msi"
  shutil.copy(MSI_DIR + '\\DeploymentSolutionLanguages_x64.msi', 'C:\\output_msi')
  print "copying language msi to builddev"
  #shutil.copy(MSI_DIR + '\\DeploymentSolutionLanguages_x64.msi', '\\builddev.altiris.com\buildtest\DeploymentSolution\Daily_Builds\MilanMR1' +'\\' + os.environ['PLVERSION'])
...
if __name__ == '__main__':
  try:
    ...
    print "Geting build number", Build
    GetBuild()
