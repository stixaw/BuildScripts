...
REM "%4\CM\PLXML\ModifyPL.exe" -pl:"%4\CM\PLXML\ITMS_7_1_sp2.pl.xml" "-action:ProductFixVersion" "-ProductNames:Symantec ServiceDesk Solution Languages 7.1 SP2;Symantec ServiceDesk Solution 7.1 SP2" "-Version:%2" > ModifyPL_SD_Version.txt
