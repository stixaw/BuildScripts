...
def P4Submit():
  ...
  global workspace, top, dpt_trk
  localtime=time.asctime( time.localtime(time.time()) )
  LIN_OUTPUT = dpt_trk + '/output_lin/...'
  LIN_TGZ = dpt_trk + '/OEM/DS/Linux/x86/Base/ULMagent.tgz'
  LIN_PBS = dpt_trk + '/PackageBuild/package.pbs'
  LIN_ROLLOUT = dpt_trk + '/OEM/DS/Linux/x86/automation/rollout-auto.sh'
  #submit changes
